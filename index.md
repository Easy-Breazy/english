...
<body>
  ...
  <div class="container">
   ...
   <div id="reviews-section">
      ...
      <h2>Отзывы</h2>
      <div class="review">
        <h4 onclick="toggleReviewContent(0)">Любовь, юрист <br> TOEFL, успешное поступление в америкаский колледж</h4>
      ...
      <div class="review">
        <h4 onclick="toggleReviewContent(1)">Nina, преподаватель <br> преподавание на английском в Хельсинкском университете </h4>
        <div class="review-content">
      ...
      <div class="review">
        <h4 onclick="toggleReviewContent(2)">Марина и Слава, фронтенд-разработчики <br> Адаптация к жизни в США, поиск работы</h4>
        <div class="review-content">
...
<div class="review">
        <h4 onclick="toggleReviewContent(1)">Виктор, режиссер-документалист <br> Адаптация к жизни в США </h4>
        <div class="review-content">
