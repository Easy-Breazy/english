...
<body>
  ...
  <div class="container">
   ...
   <div class="about-me">
      ...
      <p>
       Меня зовут Анастасия Большакова, я профессиональный преподаватель английского с обширным международным опытом.  
      </p>
      <p>
       <ul>
          <li>Много лет прожила в США и Европе</li>
          <li>Английский на уровне носителя</li>
          <li>Замужем за носителем, дети-билингвы</li>
     ...
     <p> <b> Опыт работы</b>
       <ul>
          ...
          <li>Курсы делового английского для ведущих корпораций Финляндии</li>
         <li>Сотрудничество с вузами, языковыми центрами</li>
          <li>Переводчик в «РИА Новости», Библиотеке Конгресса США </li>
        </ul>
      </p>
    </div>
   ...
   <div id="reviews-section">
      ...
      <div class="review">
        <h4 onclick="toggleReviewContent(2)" style="color: #1e6bb8;">Марина и Слава, фронтенд-разработчики <br> Адаптация к жизни в США, поиск работы</h4>
        <div class="review-content">
...
<div class="review">
        ...
        <div class="review-content">
          <p>Русскоязычный преподаватель с идеальным английским произношением. Редкое сочетание для этого сайта. Интеллигентно, спокойно, но верно наращивает ваши говорительные, слушательные и грамматические навыки. Рекомендую!</p>
        </div>
      </div>
        </div>
      </div>
