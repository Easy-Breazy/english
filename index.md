...
<body>
  ...
  <div class="container">
   ...
   <div class="about-me">
      ...
      <p>
       Меня зовут Анастасия Большакова, я профессиональный преподаватель английского с огромным международным опытом.  
      </p>
      <p>
       <ul>
     ...
     <p> <b> Опыт работы</b>
       <ul>
         ...
         <li>Обширная частная практика: обучение менеджеров высшего звена ведущих российских и зврубежных компаний</li>
        </ul>
      </p>
    </div>
